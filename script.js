...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function getImagePath(file) {
    if (window.innerWidth <= 768) {
      return file.replace(".webp", "-small.webp"); // versión reducida para móviles
    }
    return file;
  }

  const imagenes = [
    getImagePath("/img/portada-principal/img-portada2.webp"),
    getImagePath("/img/portada-principal/img-portada3.webp"),
    getImagePath("/img/portada-principal/img-portada4.webp"),
    getImagePath("/img/portada-principal/img-portada5.webp"),
  ];
  let index = 0;
